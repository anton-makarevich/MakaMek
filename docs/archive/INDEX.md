...
Historical and superseded documents preserved for reference. These files are no longer actively maintained; consult the relevant category indexes for current documentation.

## Documents

| Document | Summary | Status |
|----------|---------|--------|
| [MakaMek-Wiki.md](MakaMek-Wiki.md) | Original wiki entry-point stub predating the current docs hierarchy | Superseded by `docs/INDEX.md` |
| [MakaMek-MVP-Gap-Analysis(0.40.31).md](MakaMek-MVP-Gap-Analysis%280.40.31%29.md) | Gap analysis against MVP requirements as of version 0.40.31 | Superseded by v0.41.15 and v0.42.27 analyses |
| [MakaMek-MVP-Gap-Analysis(0.41.15).md](MakaMek-MVP-Gap-Analysis%280.41.15%29.md) | Gap analysis against MVP requirements as of version 0.41.15 | Superseded by v0.42.27 analysis in `project/` |
