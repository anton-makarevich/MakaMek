...
public interface IRulesProvider
{
    ...
    /// <summary>
    /// Gets the movement penalty caused by the unit's current heat level.
    /// </summary>
    int GetHeatMovementPenalty(int heatLevel);

    /// <summary>
    /// Gets the attack-roll penalty caused by the unit's current heat level.
    /// </summary>
    int GetHeatAttackPenalty(int heatLevel);

    /// <summary>
    /// Gets the number of pilot hits caused by failed life support at a heat level.
    /// </summary>
    int GetLifeSupportPilotDamage(int heatLevel);
