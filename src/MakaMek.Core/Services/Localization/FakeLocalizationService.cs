...
public class FakeLocalizationService: ILocalizationService
{
    public string GetString(string key)
    {
        return key switch
        {
            ...
            "Command_WeaponAttackResolution_HitLocation_ArmorAndStructure" => "{0}: {1} armor, {2} structure damage (Roll: {3})",
            "Command_WeaponAttackResolution_HitLocation_ArmorOnly" => "{0}: {1} armor damage (Roll: {2})",
            "Command_WeaponAttackResolution_HitLocation_StructureOnly" => "{0}: {1} structure damage (Roll: {2})",
            "Command_WeaponAttackResolution_HitLocationTransfer" => "{0} → {1}: {2} damage (Roll: {3})",
            "Command_WeaponAttackResolution_HitLocationTransfer_ArmorAndStructure" => "{0} → {1}: {2} armor, {3} structure damage (Roll: {4})",
            "Command_WeaponAttackResolution_HitLocationTransfer_ArmorOnly" => "{0} → {1}: {2} armor damage (Roll: {3})",
            "Command_WeaponAttackResolution_HitLocationTransfer_StructureOnly" => "{0} → {1}: {2} structure damage (Roll: {3})",
