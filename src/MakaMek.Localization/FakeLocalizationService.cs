...
public class FakeLocalizationService: ILocalizationService
{
    public string GetString(string key)
    {
        return key switch
        {
            ...
            "MapConfig_Width" => "Width: {0} hexes",
            "MapConfig_Height" => "Height: {0} hexes",
            "MapConfig_ForestCoverage" => "Forest Coverage: {0}%",
            "MapConfig_LightWoods" => "Light Woods: {0}%",
            "MapConfig_HillCoverage" => "Hill Coverage: {0}%",
            "MapConfig_MaxElevation" => "Max Elevation: {0}",
