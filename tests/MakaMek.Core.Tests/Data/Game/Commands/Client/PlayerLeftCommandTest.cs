...
public class PlayerLeftCommandTest
{
    ...
    public void Render_ShouldFormatCorrectly()
    {
        ...
        game.Players.Returns(new List<IPlayer> { new Player(sut.PlayerId, "Player 1", PlayerControlType.Human) });
    ...
    public void Render_ShouldReturnDefaultPlayerName_WhenPlayerNotFound()
    {
        ...
        var game = Substitute.For<IGame>();
        game.Players.Returns(new List<IPlayer> { new Player(Guid.NewGuid(), "Player 2", PlayerControlType.Human) });
