...
public class ClassicBattletechComponentProviderTests
{
    ...
    public void GetDefinition_ValidNonFixedActuatorComponent_ShouldReturnCorrectDefinition(
    ...
    [InlineData(MakaMekComponent.LowerLegActuator)]
    [InlineData(MakaMekComponent.FootActuator)]
    public void CreateComponent_WithComponentData_ValidActuatorComponent_ShouldReturnComponentWithCorrectState(
        MakaMekComponent componentType)
    {
        // Arrange
    ...
    [InlineData(MakaMekComponent.PPC)]
    [InlineData(MakaMekComponent.Flamer)]
    public void CreateComponent_WithComponentData_ValidWeaponComponent_ShouldReturnComponentWithCorrectState(
        MakaMekComponent componentType)
    {
        // Arrange
        var componentData = new ComponentData
    ...
    [InlineData(MakaMekComponent.ISAmmoLRM5)]
    [InlineData(MakaMekComponent.ISAmmoAC2)]
    public void CreateComponent_WithComponentData_ValidAmmoComponent_ShouldReturnComponentWithCorrectState(
        MakaMekComponent componentType)
    {
        // Arrange
    ...
    [Fact]
    public void CreateComponent_WithRearFacingWeaponStateData_ShouldCreateRearFacingWeapon()
    {
        // Arrange
        var componentData = new ComponentData
        {
        ...
        // Act
        var weapon = _sut.CreateComponent(MakaMekComponent.MediumLaser, componentData) as Weapon;

        // Assert
        weapon.ShouldNotBeNull();
        
        // Verify round-trip serialization
        var serialized = weapon.ToData();
        serialized.SpecificData.ShouldBeOfType<WeaponStateData>();
        ((WeaponStateData)serialized.SpecificData).MountingOptions.ShouldBe(MountingOptions.Rear);
    }

    [Fact]
    public void CreateComponent_WithHalfCapacityAmmoStateData_ShouldCreateHalfMassAmmo()
    {
        // Arrange
        var componentData = new ComponentData
        {
        ...
        // Act
        var ammo = _sut.CreateComponent(MakaMekComponent.ISAmmoMG, componentData) as Ammo;

        // Assert
        ammo.ShouldNotBeNull();
        ammo.Mass.ShouldBe(0.5m);
        ammo.RemainingShots.ShouldBe(100); // Half of 200 rounds for MG

        // Verify round-trip serialization
        var serialized = ammo.ToData();
        serialized.SpecificData.ShouldBeOfType<AmmoStateData>();
        var ammoState = (AmmoStateData)serialized.SpecificData;
