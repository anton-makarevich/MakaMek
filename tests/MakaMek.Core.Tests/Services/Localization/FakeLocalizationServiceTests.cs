...
public class FakeLocalizationServiceTests
{
    ...
    [InlineData("About_ContactStatement", "If there are any problems using any of in-game material, or you have any questions please please feel free to contact me.")]
