...
public class FakeLocalizationServiceTests
{
    ...
    [InlineData("Command_WeaponAttackResolution_HitLocation_ArmorAndStructure", "{0}: {1} armor, {2} structure damage (Roll: {3})")]
    [InlineData("Command_WeaponAttackResolution_HitLocation_ArmorOnly", "{0}: {1} armor damage (Roll: {2})")]
    [InlineData("Command_WeaponAttackResolution_HitLocation_StructureOnly", "{0}: {1} structure damage (Roll: {2})")]
    [InlineData("Command_WeaponAttackResolution_HitLocationTransfer_ArmorAndStructure", "{0} → {1}: {2} armor, {3} structure damage (Roll: {4})")]
    [InlineData("Command_WeaponAttackResolution_HitLocationTransfer_ArmorOnly", "{0} → {1}: {2} armor damage (Roll: {3})")]
    [InlineData("Command_WeaponAttackResolution_HitLocationTransfer_StructureOnly", "{0} → {1}: {2} structure damage (Roll: {3})")]
