...
public class FakeLocalizationServiceTests
{
    ...
    [InlineData("Settings_Data_Providers_Type", "Type")]
    [InlineData("Settings_Data_Providers_AssetType", "Asset Type")]
    [InlineData("Settings_Data_Providers_UrlOrPath", "URL or Path")]
    [InlineData("Settings_Data_Providers_UrlOrPathRequired", "URL or path is required.")]
    [InlineData("Settings_Data_Providers_Count", "{0} items")]
    [InlineData("Settings_Data_Providers_Reload", "Reload Assets")]
    [InlineData("Settings_Data_Providers_Activate", "Active")]
    [InlineData("Settings_Data_Providers_Edit", "Edit")]
    [InlineData("Settings_Data_Providers_Save", "Save")]
    [InlineData("Settings_Data_Providers_Cancel", "Cancel")]
    [InlineData("Settings_Data_Providers_Remove", "Remove")]
    ...
    [InlineData("Settings_Hub_AddDialogTitle", "Add Hub")]
    [InlineData("Settings_Hub_UrlRequired", "Hub URL is required.")]
    ...
    [Theory]
    [InlineData("Network_HostMode", "Host Mode")]
    ...
    public void GetString_NetworkHosting_ReturnsExpectedString(string key, string expected)
    {
        // Arrange
        var localizationService = new FakeLocalizationService();
    ...
    [InlineData("Join_LobbyMapPreview", "Lobby Map")]
