...
public class FakeLocalizationServiceTests
{
    ...
    [InlineData("MapConfig_Width", "Width: {0} hexes")]
    [InlineData("MapConfig_Height", "Height: {0} hexes")]
    [InlineData("MapConfig_ForestCoverage", "Forest Coverage: {0}%")]
    [InlineData("MapConfig_LightWoods", "Light Woods: {0}%")]
    [InlineData("MapConfig_HillCoverage", "Hill Coverage: {0}%")]
    [InlineData("MapConfig_MaxElevation", "Max Elevation: {0}")]
