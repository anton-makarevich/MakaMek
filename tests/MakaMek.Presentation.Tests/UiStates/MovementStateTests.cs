...
public class MovementStateTests
{
    ...
    {
        // Arrange
        _unit1.Deploy(new HexPosition(new HexCoordinates(1,2),HexDirection.Bottom), null);
        _sut.HandleUnitSelectionFromList(_unit1);
    ...
    public void HandleHexSelection_DoesNotSelectsUnit_WhenUnitIsOnHex_ButNotOwnedByActivePlayer()
    {
        ...
        unit.Deploy(new HexPosition(position,HexDirection.Bottom), null);
    ...
    public void HandleHexSelection_DoesNothing_WhenNoUnitOnHex()
    {
        ...
        _unit1.Deploy(new HexPosition(1, 2, HexDirection.Bottom), null);
    ...
    public void HandleMovementTypeSelection_CalculatesBackwardReachableHexes_WhenWalking()
    {
        ...
        _unit1.Deploy(startPosition, null);
        _sut.HandleUnitSelectionFromList(_unit1);
    ...
    public void HandleUnitSelection_RedirectionsToStartHex_WhenUnitSelectedAgain()
    {
        ...
        var startPosition = new HexPosition(new HexCoordinates(1, 1), HexDirection.Top);
        var unit = _battleMapViewModel.Units.First();
        unit.Deploy(startPosition, null);
    ...
    [Fact]
    public void HandleDirectionSelection_ResetsSelection_WhenClickingOutsideReachableHexes()
    {
        // Arrange
        var unit = _battleMapViewModel.Units.First();
        var startPosition = new HexPosition(new HexCoordinates(1, 2), HexDirection.Top);
    ...
    [Fact]
    public void HandleDirectionSelection_ShouldNotResetSelection_WhenClickingOutsideReachableHexes_ButInPostStandupMovement()
    {
        // Arrange
        var position = new HexPosition(new HexCoordinates(1, 2), HexDirection.Bottom);
        var proneMech = _battleMapViewModel.Units.First() as Mech;
    ...
    public void GetAvailableActions_NoJumpJets_DoesNotShowJumpOption()
    {
        ...
        var unitWithoutJumpJets = new MechFactory(
                ...
                _localizationService)
            .Create(unitData);
        _sut.HandleUnitSelectionFromList(unitWithoutJumpJets);
    ...
    public void HandleStandupAttempt_ShowsDirectionSelector()
    {
        ...
        proneMech!.Deploy(new HexPosition(1,1,HexDirection.Bottom), null);
        proneMech.SetProne();
        _sut.HandleUnitSelectionFromList(proneMech);
    ...
    public void GetAvailableActions_MechJustStoodUp_ExcludesJumpAction()
    {
        ...
        mechThatStoodUp.RegisterStandupAttempt();
        mechThatStoodUp.StandUp(HexDirection.Bottom);

        _sut.HandleUnitSelectionFromList(mechThatStoodUp);
    ...
    public void ResumeMovementAfterStandup_ShouldNotHighlightReachableHexes_WhenMechHasNoMp()
    {
        ...
        // Simulate server's OnMoveUnit response to deduct standup cost
        var standupPath = MovementPath.CreateSingleSegmentPath(proneMech.Position!, MovementType.Walk)
            .WithLastSegmentEvent(
                new SegmentEvent(SegmentEventType.StandupAttempt),
                new StandUpAttemptMovementCost { Value = 2 });
        proneMech.Move(standupPath, null, false);
    ...
    public void CanSelectUnit_BlocksOtherFriendly_WhenDeferredAfterFall()
    {
        ...
        _sut.HandleUnitSelectionFromList(mech1);
        _sut.HandleMovementTypeSelection(MovementType.Walk);
        mech1.SetProne();
    ...
    public void StandupWithZeroRemainingMp_CompletesMovement_WithCompletedCommand()
    {
        ...
        // Simulate server's OnMoveUnit response to deduct standup cost
        var standupPath = MovementPath.CreateSingleSegmentPath(mech.Position!, MovementType.Walk)
            .WithLastSegmentEvent(
                new SegmentEvent(SegmentEventType.StandupAttempt),
                new StandUpAttemptMovementCost { Value = 2 });
        mech.Move(standupPath, null, false);
