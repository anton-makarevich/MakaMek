...
public class PlayerViewModelTests
{
    ...
    {
        // Arrange
        var sut = new PlayerViewModel(new Player(Guid.NewGuid(), "Player1", PlayerControlType.Human),true);
    ...
    {
        // Arrange
        var sut = new PlayerViewModel(new Player(Guid.NewGuid(), "Player1", PlayerControlType.Human, "#FF0033"),true);
    ...
    {
        // Arrange
        var sut = new PlayerViewModel(new Player(Guid.NewGuid(), "Player", PlayerControlType.Human), isLocal);
    ...
    {
        // Arrange
        var sut = new PlayerViewModel(new Player(Guid.NewGuid(), "Player", PlayerControlType.Human), true);
        var unit = MechFactoryTests.CreateDummyMechData();
        sut.AddUnit(unit); // Add a unit
    ...
    public void StartEditingName_ShouldNotSetIsEditing_WhenCanEditIsFalse()
    {
        ...
        var sut = new PlayerViewModel(new Player(Guid.NewGuid(), "Player1", PlayerControlType.Human), false);
    ...
    {
        // Arrange
        var sut = new PlayerViewModel(new Player(Guid.NewGuid(), "Original Name", PlayerControlType.Human), true);
        sut.StartEditingName();
